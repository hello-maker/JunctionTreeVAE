...
import sys
import os
sys.path.append("/home/csy/work/JTVAE_Re")
sys.path.append("/home/csy/work/JTVAE_Re/jtnn") 
#sys.path.append("/home/csy/work/Version_jtnn") 
print(os.getcwd())
from jtnn import *
import rdkit
...
for epoch in range(MAX_EPOCH):
    ...
    for it, batch in enumerate(dataloader):
        ...
        if (it + 1) % PRINT_ITER == 0:
            ...
            print("{} / {}".format(len(dataloader), it+1))
